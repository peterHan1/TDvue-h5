...
import selfInvestExplain from 'components/selfInvestExplain/selfInvestExplain'
...
import encyclopediaDetail from 'components/helpCenter/encyclopediaDetail'
Vue.use(Router)
...
export default new Router({
	...
	routes: [
		...
		{
			path: '/selfInvestExplain',
			component: selfInvestExplain,
			meta: {
				title: '自动投标规则说明'
			}
		},
